...
export default function FloatingWA() {
  return (
    ...
    >
      ...
      <div className="w-14 h-14 md:w-16 md:h-16 bg-[#25D366] rounded-full shadow-2xl flex items-center justify-center text-white animate-pulse-gold transform transition-transform group-hover:scale-110">
        <svg
