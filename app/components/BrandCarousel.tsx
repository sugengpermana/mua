  ...
  return (
    <section className="py-6 md:py-8 bg-charcoal overflow-hidden border-t border-white/5">
      <div className="max-w-5xl mx-auto px-5">
        <div className="flex items-center justify-center gap-6 md:gap-0 md:justify-between flex-wrap">
          {/* Live indicator */}
          ...
          <div className="flex items-center divide-x divide-white/10">
            <AnimatedStat target={500} suffix="+" label="Klien" />
            <AnimatedStat target={5} suffix="+" label="Tahun" />
            <AnimatedStat target={98} suffix="%" label="Kepuasan" />
          </div>
